...
\begin{proof}
	...
	\[
		N\left( a+b\sqrt{-5}  \right) =\left( a+b \sqrt{-5}  \right) \left( a-b \sqrt{-5}  \right) =a^2+ab \sqrt{-5} -ab \sqrt{-5} -b^2i^2 \sqrt{5} ^2=a^2 + 25b^2
	.\]
	Assume for contradiction that there exist $a,b\in\mathbb{Z} $ such that $N(a+b\sqrt{-5} )=0$. Then $a^2+25b^2=0$. Since $a+b\sqrt{-5} \neq 0$, at least one of $a,b$ is nonzero.
	\begin{itemize}
		\item ($a=0,b\neq 0$) $N(a+b\sqrt{-5} )=a^2>0$;
		\item ($a\neq 0,b=0$) $N(a+b\sqrt{-5} )=25b^2>0$;
		\item $(a,b \neq 0$) Both $a^2,b^2 > 0$ meaning $a^2 +25b^2 > 0$.
	\end{itemize}
...
\end{problem}
\begin{proof}
	Recall that Euclidean domains are PIDs, meaning every ideal is principal. By \cref{5}, a maximal ideal exists. Since the maximal ideal is principal, let $a\in R$ be an element such that $(a)$ is maximal. By \cref{4.2}, $R/(a)$ is a field.
\end{proof}
