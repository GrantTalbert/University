...
We have not discussed cochain complexes yet, but there is not much to discuss. A cochain complex is just a chain complex where the indices go up, instead of down. Equivalently, the category of cochain complexes is the opposite category of the category of chain complexes. They are essentially the same thing, but we maintain the distinction for a few useful reasons. We denote cochain complexes via $X^{\bullet} $ rather than $X_{\bullet} $. We call the homology of a cochain complex its \emph{cohomology}.
