...
\begin{example}\label{7.2.3}
	Let $A$ be an associative $R$-algebra. Then any $A$-module $M$ is also a $\Lie(A)$-module by taking the action $\Lie(A)\otimes_RM \to M$ to be the same as the action $A\otimes _AM \to M$.
\end{example}
