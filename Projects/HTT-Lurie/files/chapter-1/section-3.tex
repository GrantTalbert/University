...
\begin{proposition}\label{1.3.1.5}
	A morphism of simplicial sets $f : A \to X$ is monic (levelwise injective) if and only if it has the right lifting property with respect to the canonical inclusion $\partial \Delta ^1\hookrightarrow \Delta ^1$.
\end{proposition}
\begin{proof}
	apparently this follows from ANOTHER theorem idk
\end{proof}
