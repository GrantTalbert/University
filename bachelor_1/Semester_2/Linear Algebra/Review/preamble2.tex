...
%numbered theorems
\declaretheorem[numbered=yes, style=thmbox, name=Definition]{definition}
...
\declaretheorem[numbered=yes, style=nobox, name=Exercise]{exercise}
...
\declaretheorem[numbered=yes, style=egline, name=Solution]{setsolution}
\newenvironment{solution}[1][]{\begin{setlongsolution}}{\end{setlongsolution}}
\declaretheorem[sibling=setsolution, style=longegline, name=Solution]{setlongsolution}
\newenvironment{longsolution}[1][]{\begin{setlongsolution}}{\end{setlongsolution}}
%proof environment
