...
\begin{proof}
	...
	One thing to remark about the structure is that for $(a,b)$ a basis position, all linear combinations are of the form $(F_na+F_{n+1}b,F_{n+1}a+F_{n+2}b)$. Proof of this will follow very fast via induction (will it?). This doesnt arrise for every $n$ so probably prudent to write $F_{2n+1}$ instead, altho idk if its odd or evens. What even is it with the even subset of fibonaccis?
